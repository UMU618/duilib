...
class DUILIB_API CListUI : public CVerticalLayoutUI, public IListUI {
 public:
  ...
  bool SetMultiItemIndex(CControlUI* pStartControl,
                         int iCount,
                         int iNewStartIndex);
  int GetCount() const;
...
class DUILIB_API CListHeaderItemUI : public CControlUI {
 public:
  ...
  // UMU {
  DWORD GetColumnTextStyle() const;
  void SetColumnTextStyle(UINT text_style);
  // UMU }
...
class DUILIB_API CListContainerElementUI : public CContainerUI,
                                           public IListItemUI {
 public:
