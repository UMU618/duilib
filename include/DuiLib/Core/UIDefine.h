...
#define DUI_BASE_BEGIN_MESSAGE_MAP(theClass)                               \
  const DUI_MSGMAP* PASCAL theClass::_GetBaseMessageMap() { return NULL; } \
...
#else
#pragma message( \
    "WARNING: You need to implement DUI_DEPRECATED for this compiler")
...
///
//////////////END控件名称宏定义//////////////////////////////////////////////////
const UINT WM_DELAYED_CLEANUP = WM_APP + 1;
const UINT WM_DUI_MENU_ITEM = WM_APP + 2;
